...
- 增加touch模块，移动端触摸事件touchstart、touchmove、touchend、touchcancel、 tap、press、 doubleTap、 swipe、 swipeLeft、swipeRight、 swipeUp、 swipeDown。touch == on、untouch == off。touch和untouch只对触摸事件生效。on和off都可以。
  增加自定义事件，触发trigger。
